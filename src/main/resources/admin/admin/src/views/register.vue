  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="楼栋" class="input" v-if="tableName=='suguan'">
			  <el-input v-model="ruleForm.loudong" autocomplete="off" placeholder="楼栋"  />
			</el-form-item>
			<!-- <div v-if="tableName=='suguan'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='suguan'">
