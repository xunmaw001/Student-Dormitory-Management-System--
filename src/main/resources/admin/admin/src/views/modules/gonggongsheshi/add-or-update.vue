<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.sheshitupian" label="设施图片" prop="sheshitupian">
          <file-upload
          tip="点击上传设施图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.sheshitupian" label="设施图片" prop="sheshitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.sheshitupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="设施投入日期" prop="sheshitoururiqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.sheshitoururiqi" 
                type="date"
                :readonly="ro.sheshitoururiqi"
                placeholder="设施投入日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.sheshitoururiqi" label="设施投入日期" prop="sheshitoururiqi">
              <el-input v-model="ruleForm.sheshitoururiqi" 
                placeholder="设施投入日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="维修保养情况" prop="weixiubaoyangqingkuang">
          <el-select :disabled="ro.weixiubaoyangqingkuang" v-model="ruleForm.weixiubaoyangqingkuang" placeholder="请选择维修保养情况">
            <el-option
                v-for="(item,index) in weixiubaoyangqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="维修保养情况" prop="weixiubaoyangqingkuang">
	      <el-input v-model="ruleForm.weixiubaoyangqingkuang"
                placeholder="维修保养情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="设施使用情况" prop="sheshishiyongqingkuang">
          <el-input v-model="ruleForm.sheshishiyongqingkuang" 
              placeholder="设施使用情况" clearable  :readonly="ro.sheshishiyongqingkuang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="设施使用情况" prop="sheshishiyongqingkuang">
              <el-input v-model="ruleForm.sheshishiyongqingkuang" 
                placeholder="设施使用情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="检查日志" prop="jiancharizhi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jiancharizhi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiancharizhi" label="检查日志" prop="jiancharizhi">
                    <span v-html="ruleForm.jiancharizhi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	sheshitupian : false,
	sheshitoururiqi : false,
	dengjiriqi : false,
	weixiubaoyangqingkuang : false,
	sheshishiyongqingkuang : false,
	jiancharizhi : false,
      },
      ruleForm: {
        sheshimingcheng: '',
        ...
        sheshitoururiqi: '',
        dengjiriqi: '',
        weixiubaoyangqingkuang: '',
        sheshishiyongqingkuang: '',
        jiancharizhi: '',
      },
          weixiubaoyangqingkuangOptions: [],
      rules: {
          sheshimingcheng: [
          ],
          sheshitupian: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.sheshitupian = true;
          ...
          if(o=='sheshitoururiqi'){
            this.ruleForm.sheshitoururiqi = obj[o];
	    this.ro.sheshitoururiqi = true;
            continue;
          }
          if(o=='dengjiriqi'){
	    ...
	    this.ro.dengjiriqi = true;
          ...
          if(o=='weixiubaoyangqingkuang'){
            this.ruleForm.weixiubaoyangqingkuang = obj[o];
	    this.ro.weixiubaoyangqingkuang = true;
            continue;
          }
          if(o=='sheshishiyongqingkuang'){
            this.ruleForm.sheshishiyongqingkuang = obj[o];
	    this.ro.sheshishiyongqingkuang = true;
            continue;
          }
          if(o=='jiancharizhi'){
            this.ruleForm.jiancharizhi = obj[o];
	    this.ro.jiancharizhi = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.weixiubaoyangqingkuangOptions = "良好,危险".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.jiancharizhi = this.ruleForm.jiancharizhi.replace(reg,'../../../springboot5xth9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
